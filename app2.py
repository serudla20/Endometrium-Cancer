...
def image():
    if request.method == 'POST':
        ...
        # Gaussian filter
        gaussian_filtered = cv2.GaussianBlur(luminosity_gray.astype("uint8"), (5, 5), 1)
       ...
       # Apply Gaussian Blur and thresholding
        ...
        for contour in contours:
            ...
            if area > tumor_threshold and circularity > 0.6:
                tumor_count += 1
                label = "Tumor"
            elif lymph_node_threshold < area <= tumor_threshold and circularity > 0.4:
                lymph_node_count += 1
                label = "Lymph Node"
            ...
            if solidity > 0.7 and circularity > 0.6:
                grade = "Low Grade (Well-Organized)"
            elif 0.4 < solidity <= 0.7 and 0.4 < circularity <= 0.6:
        ...
        # Define the classes
        class_labels = os.listdir("D:\\P7\\test")
